    ...
    int checkPIN(int PIN)
    {
        ...
        if(nr==4)
        {
            ...
            for(int i=1;i<=256;i++)
            {
                ...
                {
                    system("CLS");
                    cout<<"The PIN is already taken, please choose a new one."<<endl;
                    cnt=1;
                }
            }
            if(cnt>0)
    ...
    int AuthCheck(int &aux)
    {
        ...
        {
            system("CLS");
            cout<<"User cannot be (all) '0', please enter a correct PIN: ";
            cin>>authname;
        }
        for(int i=1;i<=255;i++)
        {
    ...
    int main()
    {
        ...
        if(input==2)
        {
            while(input>0)
            {
            cout<<"Enter the PIN(user) you wish to have(The PIN needs to be 4 digits, and composed of numbers): "<<endl;
            cin>>registerPIN;
